...
resource "google_cloudfunctions2_function" "format_converter" {
  ...
  service_config {
    max_instance_count = var.function_service_config.format_converter.max_instance_count
    min_instance_count = var.function_service_config.format_converter.min_instance_count
    available_memory   = var.function_service_config.format_converter.available_memory
    timeout_seconds    = var.function_service_config.format_converter.timeout_seconds
  }
